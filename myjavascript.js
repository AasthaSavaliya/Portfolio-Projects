   ...
   function time_based_change() {
      ...
      if ($("input[name=mode]:checked").val() == "timeBased") {
         ...
         $("#yellowEW").removeAttr("disabled");
         $("#greenEW").removeAttr("disabled");

         $("#yellowNS").css("background-color", "#f8eeee");
         $("#greenNS").css("background-color", "#f8eeee");

         $("#yellowEW").css("background-color", "#f8eeee");
         $("#greenEW").css("background-color", "#f8eeee");
      }
   };
   ...
   function sync_time() {
      ...
      if (yellowEW !== "" && greenEW !== "") {
         ...
         var stop_sec = parseInt(yellowNS) + parseInt(greenNS);
         $("#redEW").val(stop_sec);
      } else {
         $("#redEW").val("");
      }
   ...
   var temp = parseInt($("#yellowNS").val()) + parseInt($("#greenNS").val());

   $("#redNS").val(temp);
   $("#redEW").val(temp);

   $("#yellowEW").val($("#yellowNS").val());
   $("#greenEW").val($("#greenNS").val());
   ...
   function call3() {
      var greenNS = $("#greenNS").val();
      var time = parseInt(greenNS) * 1000;
   ...
   function call4() {
      var yellowNS = $("#yellowNS").val();
      var time = parseInt(yellowNS) * 1000;
